...
# model_name = 'baseline'
dir_img = r'/hdd2/Bo Yu/data/HL/train/train_image'                      # 输入图像路径
dir_boundary = r'/hdd2/Bo Yu/data/HL/train/train_boundary'                   # 输入边界路径
dir_mask = r'/hdd2/Bo Yu/data/HL/train/train_mask'
dir_checkpoint = r'/home/yubo/Bsinet_yb/Mymodel/Mloss/hl/baseline' # 模型保存位置

log_csv_path = r'/home/yubo/Bsinet_yb/Mymodel/Mloss/hl/baseline/LossData.csv'         # 损失保存位置
log_file_path = r'/home/yubo/Bsinet_yb/Mymodel/Mloss/hl/baseline/TrainData'                            # 训练过程保存位置
config_path = r'/home/yubo/Bsinet_yb/Mymodel/Mloss/hl/baseline/ParaData'                            # 参数保存位置
model_name = 'baseline'
...
if __name__ == '__main__':
    ...
    # 初始化模型
    net = Tripmodel(input_channels=3, num_classes=1)
