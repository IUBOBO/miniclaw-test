...
# from models.newdecoder7 import MYNet as Net
from model import Tripmodel as Net
#
# from models.yb_REAU import REAUNet as Net
# from models.yb_SEA import SEANet as Net
# from models.yb_BSI import BsiNet as Net
# from models.yb_DLV3 import DeepLab as Net
# from models.HBG_yb import Field as Net

# NET_NAME = 'TripNET'

import datasets_lss as Data
...
def predict(net, opt):
    ...
    # imgA_dir = os.path.join(opt.test_dir, 'add/gaussian_noise')
    imgA_dir = os.path.join(opt.test_dir, 'add/blur')
    # imgA_dir = os.path.join(opt.test_dir, 'img')
