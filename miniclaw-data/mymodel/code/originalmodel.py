...
class LGSABlock(nn.Module):
    """
    Local-Global Self-Attention Block
    """
    def __init__(self, dim, num_heads, window_size=7, global_weight=0.5, attn_drop=0.1, mlp_drop=0.1):
        super().__init__()
        self.norm1 = nn.LayerNorm(dim)
        self.local_attn = LocalWindowAttention(dim, num_heads, window_size, attn_drop)
        self.global_attn = GlobalAttention(dim, num_heads, attn_drop)
        # self.global_attn = GlobalContextBlock(dim)
