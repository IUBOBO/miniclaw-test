...
dir_img = r'F:\Bo Yu\data\Xinjiang\train\img\\'
dir_mask1 = r'F:\Bo Yu\data\Xinjiang\train\mask\\'
dir_mask2 = r'F:\Bo Yu\data\Xinjiang\train\dist_contour\\'
dir_mask3 = r'F:\Bo Yu\data\Xinjiang\train\boundary\\'

dir_checkpoint = "F:\Bo Yu\\Net\SEANet\yb_test\SEA_skpts_xj\\SEA_lsn"
...
def train_net(net, device, epochs=100, batch_size=1, lr=0.0001, val_percent=0.1, save_cp=True, img_scale=1):
    dataset = BasicDataset(dir_img, dir_mask1, dir_mask2,dir_mask3,img_scale)
    ...
    for epoch in range(epochs):
        ...
        with tqdm(total=n_train, desc=f'Epoch {epoch + 1}/{epochs}', unit='img') as pbar:
            for batch in train_loader:
                ...
                loss3 = criterion3(masks_pred3,true_masks3)
        ...
        with torch.no_grad():
            for batch in val_loader:
                ...
                loss2 = criterion2(masks_pred2, true_masks2)
                loss3 = criterion3(masks_pred3, true_masks3)
                print("mask:", loss1, "dist:", loss2, "edge:", loss3)
                loss = (loss1 + loss2 + loss3)/1
        ...
        if save_cp:
            try:
                ...
                pass
            torch.save(net.state_dict(), os.path.join(dir_checkpoint, f'CP_epoch{epoch + 1}_SEANet_SC_increase.pth'))
