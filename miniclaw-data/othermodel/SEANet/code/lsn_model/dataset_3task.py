...
class BasicDataset(Dataset):
    def __init__(self, imgs_dir, masks_dir1, masks_dir2, masks_dir3, scale=1):
    ...
    def __getitem__(self, i):
        ...
        mask1 = self.preprocess( mask1, self.scale)
        mask2 = self.preprocess( mask2, self.scale)
        mask3 = self.preprocess( mask3, self.scale)
