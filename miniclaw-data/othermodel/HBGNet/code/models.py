...
class Field(nn.Module):
    def __init__(self, channel=32,num_classes=1,drop_rate=0.4):
        super(Field, self).__init__()

        self.drop = nn.Dropout2d(drop_rate)
        self.backbone = pvt_v2_b2()  # [64, 128, 320, 512]
        path = "/home/yubo/Net/HBGNet/yb_test/pvt_v2_b2.pth"
        # path = r"F:\Bo Yu\Net\HBGNet\yb_test\pvt_v2_b2.pth"
