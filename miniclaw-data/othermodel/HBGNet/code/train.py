...
if __name__ == "__main__":
    ...
    # args.train_path = r"F:\Bo Yu\data\Xinjiang\train\train_image"
    # args.train_path = r"F:\Bo Yu\data\sichuan_jiangyou\train_2\train_image"
    args.train_path = r"/media/pc/新加卷1/Bo Yu/data/HL/train/add/gaussian_noise_all/train_image"
    args.model_type = 'field'
    args.save_path = r"/media/pc/新加卷1/Bo Yu/Net/HBGNet/yb_test/HBG_HL_aussian_noise"
  ...
  #  optimizer = torch.optim.AdamW(model.parameters(), lr=1e-4)
   ...
   # scheduler = optim.lr_scheduler.StepLR(optimizer, 50, 0.1)
    ...
    for epoch in tqdm(
        ...
        if epoch % 10 == 0:
            torch.save(
                model.state_dict(), os.path.join(args.save_path, str(epoch) + ".pth")
            )
