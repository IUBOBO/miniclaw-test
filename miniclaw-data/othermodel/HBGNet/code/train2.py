...
if __name__ == "__main__":
    ...
    args.train_path = r"/media/pc/新加卷1/Bo Yu/data/HL/train/add/stripe_noise_all/train_image"
    args.model_type = 'field'
    args.save_path = r"/media/pc/新加卷1/Bo Yu/Net/HBGNet/yb_test/HBG_HL_stripe_noise"
