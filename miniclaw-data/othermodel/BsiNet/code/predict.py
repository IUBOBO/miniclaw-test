...
def get_args():
    class Args:
        gpu_id = 0
        model = r'E:\Xian-Jia He\GIS\coding\DDM-Net\data\Chongqing\ckpts\BsiNet\CP_epoch130.pth'
        input_folder = r'E:\Xian-Jia He\GIS\coding\DDM-Net\data\Chongqing\test\img'  # 指定输入图像所在的文件夹路径
        output_folder = (r'E:\Xian-Jia He\GIS\coding\DDM-Net\data\Chongqing\pred\BsiNet\boundary')  # 指定输出图像的文件夹路径
        dis_folder = r'E:\Xian-Jia He\GIS\coding\DDM-Net\data\Chongqing\pred\BsiNet\mask'
        viz = True
        no_save = False
    return Args()
...
if __name__ == '__main__':
    ...
    for i, fn in enumerate(in_files):
        ...
        # 将预测结果映射到 0-255 范围
        # boundary_pred[boundary_pred > 0.15] = 1
        # boundary_pred[boundary_pred <= 0.15] = 0
